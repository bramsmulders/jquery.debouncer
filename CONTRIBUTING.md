# Contributing to jquery.debouncer
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/jquery.debouncer
   # Navigate to the newly cloned directory
   cd jquery.debouncer
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/bramsmulders/jquery.debouncer
   ```
